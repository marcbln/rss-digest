...
> **DEPRECATED** — superseded by digester v1.1's `rss` adapter (see
> `/home/marc/workspaces/digests/digester`). This repo is frozen; only
> maintenance/security edits apply.
